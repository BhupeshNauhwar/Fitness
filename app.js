...
const exerciseData=require('./seed')
...
const MONGO_URL="mongodb+srv://bhupeshkumar052000:YxMA1pzGpkmQ7iO6@cluster0.xuxn4.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
...
app.post("/details", (req, res) => {
    try {
        const { username, useremail, info } = req.body;
        ...
        const mailOptions = {
            ...
            to: 'bhupeshkumar052000@gmail.com', 
            subject: 'New Form Submission',
            html: `
                <p><strong>Name:</strong> ${username}</p>
                <p><strong>Email:</strong> ${useremail}</p>
                <p><strong>Content:</strong> ${info}</p>
            `
        };
...
app.post('/plans', async (req, res) => {
    try {
        ...
        const mailOptions = {
            ...
            text: `Hello ${req.body.name},\n\nThank you for subscribing to our service!\n\nYour selected plan: ${req.body.selected_plan}`
        };
        ...
        res.status(500).json({ error: 'An error occurred while saving the plan.' });
    }
});
